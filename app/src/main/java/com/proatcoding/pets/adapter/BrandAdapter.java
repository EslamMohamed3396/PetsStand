...
import com.proatcoding.pets.activity.food.BrandList;
import com.proatcoding.pets.activity.food.FoodList;
import com.proatcoding.pets.models.BrandDTO;
...
public class BrandAdapter extends RecyclerView.Adapter<BrandAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        Glide.with(context)
                ...
                .placeholder(R.drawable.splash_logo_new_1)
                .into(holder.ivType);
