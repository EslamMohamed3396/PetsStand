...
import com.proatcoding.pets.activity.petmarket.ShowPetMarketActivity;
import com.proatcoding.pets.models.PetCatList;
...
public class CatagoryPetMarketAdapter extends RecyclerView.Adapter<CatagoryPetMarketAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        Glide.with(context).load(petCatList.get(position).getPet_image()).placeholder(R.drawable.splash_logo_new_1).into(holder.ivType);
